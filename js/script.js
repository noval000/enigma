...
const itemMenuFourMobile = document.querySelector('.itemMenuFourMobile');
...
itemMenuFourMobile.addEventListener('click', () => {
	menu.style.display = 'none';
	btnOpenMenu.style.display = "flex";
	headerMain.style.display = "block";
})
...
window.addEventListener("DOMContentLoaded", function() {
  [].forEach.call( document.querySelectorAll('.tel'), function(input) {
    ...
    const siteForm = document.querySelector('.formFlex');
